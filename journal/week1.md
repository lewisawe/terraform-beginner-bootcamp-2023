...
We will use `Filem5` hash to check when a file is modified, thus will need to be pushed by terraform.
We will use to check `index.html` and `error.html` have been modified
